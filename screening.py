...
def util_screening(
    ...
    if ENABLE_CAPTIAL_ADEQUACY_RATIO:
        if (
            capital_adequacy_ratio is None
            or capital_adequacy_ratio >= TARGET_CAPTIAL_ADEQUACY_RATIO
        ):
            pass
        else:
            return False
    if ENABLE_OPERATING_PROFIT_RATIO:
        ...
        if (
            operating_profit_ratio is None
            or operating_profit_ratio >= TARGET_OPERATING_PROFIT_RATIO
        ):
            pass
        else:
            return False
    if ENABLE_CONTINUOUS_DIVIDEND_INCREASE:
        ...
        if (
            continuous_dividend_increase is not None
            and continuous_dividend_increase >= TARGET_CONTINUOUS_DIVIDEND_INCREASE
        ):
            pass
        else:
            return False
...
if __name__ == "__main__":
    ...
    data_frame = pd.read_excel(
        source_path, usecols=["コード", "銘柄名", "市場・商品区分", "17業種区分"], sheet_name="Sheet1"
    )
    stock_data_frame = data_frame[
        data_frame["市場・商品区分"].isin(["市場第一部（内国株）", "市場第二部（内国株）", "JASDAQ(スタンダード・内国株）"])
    ]

    merged_data_path = "fy-merged-sheet.csv"
    merged_data_frame = pd.read_csv(
        merged_data_path,
        encoding="shift-jis",
        usecols=["コード", "年度", "自己資本比率", "売上高", "営業利益", "一株配当", "配当性向", "連続増配", "減配なし"],
    )
    ...
    for index, row in stock_data_frame.iterrows():
        ...
        try:
            ...
            print(stock_code)
            # 前日終値
            stock_previous_closing_place = parse_dom_tree(
                chart_dom_tree,
                '//*[@id="contents"]/div[3]/div[1]/div/div/div[2]/div/div[1]//tr[1]/td[1]',
                "円",
                "",
            )
            ...
            # 高値
            stock_high_place = parse_dom_tree(
                chart_dom_tree,
                '//*[@id="contents"]/div[3]/div[1]/div/div/div[2]/div/div[1]//tr[3]/td[1]',
                "円",
                "",
            )
            ...
            # 安値
            stock_low_place = parse_dom_tree(
                chart_dom_tree,
                '//*[@id="contents"]/div[3]/div[1]/div/div/div[2]/div/div[1]//tr[4]/td[1]',
                "円",
                "",
            )
            ...
            # PER
            stock_per = parse_dom_tree(
                chart_dom_tree,
                '//*[@id="contents"]/div[3]/div[1]/div/div/div[2]/div/div[2]//tr[1]/td[1]',
                "倍",
                "",
            )
            ...
            # PBR
            stock_pbr = parse_dom_tree(
                chart_dom_tree,
                '//*[@id="contents"]/div[3]/div[1]/div/div/div[2]/div/div[2]//tr[2]/td[1]',
                "倍",
                "",
            )
            ...
            # 年初来高値
            stock_high_place_per_year = parse_dom_tree(
                chart_dom_tree,
                '//*[@id="contents"]/div[3]/div[1]/div/div/div[2]/div/div[2]//tr[6]/td[1]',
                "円",
                "",
            )
            ...
            # 年初来安値
            stock_low_place_per_year = parse_dom_tree(
                chart_dom_tree,
                '//*[@id="contents"]/div[3]/div[1]/div/div/div[2]/div/div[2]//tr[7]/td[1]',
                "円",
                "",
            )
            ...
            # 配当利回り
            stock_dividend_yield = parse_dom_tree(
                chart_dom_tree,
            ...
            if stock_operating_profit is None or stock_sales is None:
                ...
                stock_operating_profit_ratio = (
                    stock_operating_profit / stock_sales
                ) * 100
